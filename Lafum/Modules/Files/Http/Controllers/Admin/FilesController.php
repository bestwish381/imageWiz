...
class FilesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view("{$viewPath}.index",['fileExtension'=>$fileExtension]);
    }
    ...
    public function findFilesInFolders()
    {
        $fileExtension=FileExtension::getUsersExtension();
        return view("files::admin.files.ffif", ['fileExtension'=>$fileExtension]);
    }

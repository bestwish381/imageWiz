...
Route::get('register', 'AuthController@getRegisterView')->name('admin.register');
Route::post('register', 'AuthController@postRegister')->name('admin.register.post');

Route::get('login/{provider}', 'AuthController@redirectToProvider')->name('admin.login.redirect');
Route::get('login/{provider}/callback', 'AuthController@handleProviderCallback')->name('admin.login.callback');

Route::get('password/reset', 'AuthController@getResetView')->name('admin.reset');

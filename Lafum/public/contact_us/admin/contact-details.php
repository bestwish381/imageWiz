...
$sql = "SELECT tblcontactdata.FullName,tblcontactdata.UserIp,tblcontactdata.EmailId,tblcontactdata.Subject,tblcontactdata.Message,tblcontactdata.PostingDate,tblcontactdata.id,tblcontactdata.PhoneNumber,tblcontactdata.EmailId,tblcontactdata.EmailId from tblcontactdata  where tblcontactdata.id=:fid";
$query = $dbh -> prepare($sql);
                ...
                <div class="table-responsive col-sm-12">
                  <table class="table">
                    ...
                    <tbody>
                        ...
                        <td><p><?php echo htmlentities($result->FullName);?></p>
                        </td>
                      </tr>
                                                                      <tr>
                        <th scope="row">Email</th>
                        <td><p><?php echo htmlentities($result->EmailId);?></p>
                        </td>
                      </tr>
                                              <tr>

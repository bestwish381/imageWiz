...
<div class="custom-template more-actions">
    ...
    <div class="custom-content">
        ...
        <div id="action-movefile" class="d-none">
            <h4 for="select_folder"><?php echo e(clean(trans('files::files.move.select_folder_to_move_file'))); ?></h4>
            <div id="available-folder"></div>
            <form method="post" action="<?php echo e(route('admin.files.movefiles')); ?>" class="form-horizontal" id="form-move-file">
        ...
        <div id="action-share" class="d-none">
            <?php echo $__env->make('files::admin.files.include.share', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php endif; ?>
        <?php if ($currentUser->hasAccess('admin.folders.create')) : ?>
        <div id="action-newfolder" class="d-none">
            <form method="POST" action="<?php echo e(route('admin.folders.storeWithAssign')); ?>" class="form-horizontal" id="folder-form" novalidate>
                <?php echo e(csrf_field()); ?>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-generate-link', function (e) { 
                ...
                if (cishare.length != 0) {
                    ...
                    var url = "<?php echo e(route('admin.files.generatelink')); ?>";
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/imagewiz/public_html/ww2.imagewiz.net/Lafum/Modules/Files/Resources/views/admin/files/include/more-actions.blade.php ENDPATH**/ ?>
...
<?php $__env->startComponent('admin::include.page.table'); ?>
    ...
    <?php $__env->slot('thead'); ?>
        <tr>
            ...
            <th><?php echo e(clean(trans('user::users.table.profile_image'))); ?></th>
    ...
    (function () {
        ...
        new DataTable('#users-table .table', {
            columns: [
                ...
                { data: 'profile_image', orderable: false, searchable: false, width: '10%' },
...
<?php echo $__env->make('admin::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/imagewiz/public_html/ww2.imagewiz.net/Lafum/Modules/User/Resources/views/admin/users/index.blade.php ENDPATH**/ ?>